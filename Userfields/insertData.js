...
pool.query(
    `INSERT INTO UserOluwasanmi2021 
                 ...
                 VALUES 
                 ('1', 'Sanmi01', 'Oluwasanmi', 'Awelewa', 'supersanmi01@gmail.com'),                
                 ('2', 'John01', 'John', 'Smith', 'johnsmith@gmail.com'),                
                 ('3', 'Jane01', 'Jane', 'Smith', 'janesmith@gmail.com'),                
                 ('4', 'Jeno01', 'Jeno', 'Bonnell', 'jbonnell@gmail.com'),                
                 ('5', 'Gussy01', 'Gussy', 'Haley', 'ghaley9@gmail.com')                
                 `,
    (err, res) => {
      if(err) {
